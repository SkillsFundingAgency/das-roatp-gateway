...
public static class ClaimsIdentityExtensions
{
    ...
    public static string GivenName(this ClaimsPrincipal user)
    {
        ...
        if (givenName == null)
        {
            throw new InvalidOperationException($"Unable to get value of claim {givenNameClaim}");
        }
    ...
    public static string Surname(this ClaimsPrincipal user)
    {
        ...
        if (surname == null)
        {
            throw new InvalidOperationException($"Unable to get value of claim {surnameClaim}");
        }
