...
public class GatewayOrganisationChecksOrchestrator : IGatewayOrganisationChecksOrchestrator
{
    ...
    {
        _logger.LogInformation("Retrieving legal name details for application {ApplicationId}", request.ApplicationId);
    ...
    {
        _logger.LogInformation("Retrieving trading name details for application {ApplicationId}", request.ApplicationId);
    ...
    {
        _logger.LogInformation("Retrieving organisation status details for application {ApplicationId}", request.ApplicationId);
    ...
    {
        _logger.LogInformation("Retrieving address check details for application {ApplicationId}", request.ApplicationId);
    ...
    {
        _logger.LogInformation("Retrieving ICO Number check details for application {ApplicationId}", request.ApplicationId);
    ...
    {
        _logger.LogInformation("Retrieving Website check details for application {ApplicationId}", request.ApplicationId);
