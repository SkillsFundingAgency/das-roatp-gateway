...
public class RoatpOrganisationSummaryApiClient : ApiClientBase<RoatpOrganisationSummaryApiClient>, IRoatpOrganisationSummaryApiClient
{
    ...
    public RoatpOrganisationSummaryApiClient(HttpClient client, ILogger<RoatpOrganisationSummaryApiClient> logger) : base(client, logger)
    { }

    public async Task<string> GetTypeOfOrganisation(Guid applicationId)
    {
        _logger.LogInformation("Retrieving type of organisation from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving company number from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving charity number from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of directors submitted in Qna QuestionTags from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of directors from companies house in ApplyData from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of pscs in Qna QuestionTags from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of pscs from companies house in ApplyData from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of trustees in Qna QuestionTags from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of trustees from charity commission in ApplyData from applicationId [{ApplicationId}]", applicationId);
    ...
    {
        _logger.LogInformation("Retrieving list of Whos in control in Qna QuestionTags from applicationId [{ApplicationId}]", applicationId);
