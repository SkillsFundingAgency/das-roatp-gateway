...
{
    public RoatpApplicationApiClient(HttpClient client, ILogger<RoatpApplicationApiClient> logger) : base(client, logger)
    { }
    ...
    {
        _logger.LogInformation("RoatpApplicationApiClient-SubmitGatewayPageAnswer - ApplicationId '{ApplicationId}' - PageId '{PageId}' - Status '{Status}' - UserName '{Username}' - Comments '{Comments}' - ClarificationAnswer '{ClarificationAnswer}'", applicationId, pageId, status, username, comments, clarificationAnswer);
        ...
        {
            _logger.LogError(ex, "RoatpApplicationApiClient - SubmitGatewayPageAnswer - Error: '{ErrorMessage}'", ex.Message);
        }
    }
        ...
        string comments, string clarificationAnswer)
    {
        ...
        {
            _logger.LogError(ex, "RoatpApplicationApiClient - SubmitGatewayPageAnswerClarification - Error: '{ErrorMessage}'", ex.Message);
        }
    }
    ...
    public async Task SubmitGatewayPageAnswerPostClarification(Guid applicationId, string pageId, string status, string userId, string username,
        string comments, string clarificationAnswer)
    {
        _logger.LogInformation("RoatpApplicationApiClient-SubmitGatewayPageAnswerPostClarification - ApplicationId '{ApplicationId}' - PageId '{PageId}' - Status '{Status}' - UserName '{Username}' - Comments '{Comments}' - ClarificationAnswer '{ClarificationAnswer}'", applicationId, pageId, status, username, comments, clarificationAnswer);
        ...
        {
            _logger.LogError(ex, "RoatpApplicationApiClient - SubmitGatewayPageAnswerPostClarification - Error: '{ErrorMessage}'", ex.Message);
        }
    }
    ...
    public async Task<bool> RemoveSubcontractorDeclarationClarificationFile(Guid applicationId, string userId, string userName, string fileName)
    {
        ...
        {
            _logger.LogError(ex, "Error when removing Subcontractor Declaration Clarification File for Application: {ApplicationId} | Filename: {FileName}", applicationId, fileName);
            return false;
        }
    }
